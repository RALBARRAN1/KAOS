...
! COMPUTE ION-NEUTRAL COLLISION FREQUENCIES:
  ...
  if (rank == 0) then
      ...
      if (SpecieT(s)%FluxTubeT(f)%M0phRT(nn, Qind) /= 0d0) then
        ...
        !MionVx(1)= (cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%phiGCT(1))/ &
        !  (sqrt(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%ellGCT(1))))* &
        !  (3d0*SpecieT(s)%FluxTubeT(f)%M1ParphRT(nn, Qind)* &
        !  cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1))* &
        !  sin(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1)))
        !MionVy(1)= (sin(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%phiGCT(1))/ &
        !  (sqrt(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%ellGCT(1))))* &
        !  (3d0*SpecieT(s)%FluxTubeT(f)%M1ParphRT(nn, Qind)* &
        !  cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1))* &
        !  sin(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1)))
        !MionVz(1)= SpecieT(s)%FluxTubeT(f)%M1ParphRT(nn, Qind)* &
        !  ((3d0*((cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1)))**2d0)- 1d0)/ &
        !  sqrt(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%ellGCT(1)))
				...
				if (SpecieT(s)%FluxTubeT(f)%MOMENTFILTERflagT(1) == 0) then
					MionVx(1)= cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%phiGCT(1))* &
						...
						sin(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%phiGCT(1))
					MionVy(1)= sin(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%phiGCT(1))* &
						(3d0*SpecieT(s)%FluxTubeT(f)%M1ParphRT(nn, Qind)* &
						cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1))* &
						sin(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1))+ &
						...
						sqrt(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%ellGCT(1))+ &
						SpecieT(s)%FluxTubeT(f)%M1Perp2phRT(nn, Qind)* &
						cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%phiGCT(1))
					MionVz(1)= SpecieT(s)%FluxTubeT(f)%M1ParphRT(nn, Qind)* &
						(3d0*(cos(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%thetaGCT(1))**2d0)- 1d0)/ &
						sqrt(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%ellGCT(1))+ &
  			...
  			if (SpecieT(s)%FluxTubeT(f)%sigmaIonNeutRT(nn, Qind) /= 0d0) then
  				...
  				! Mean number of ion-neutral collisions per time-step interval (unitless)
					nuIonNeutM(1)= SpecieT(s)%FluxTubeT(f)%QCellT(Qind)%nsnormCNeutT(1)* &
  				...
  				SpecieT(s)%FluxTubeT(f)%nuIonNeutRT(nn, Qind)= RandPoisson(1)
					...
					if (SpecieT(s)%FluxTubeT(f)%nuIonNeutRT(nn, Qind) > &
						...
						d3xCT(1)/SpecieT(s)%FluxTubeT(f)%nsnormfacT(1))) then
							SpecieT(s)%FluxTubeT(f)%nuIonNeutRT(nn, Qind)= SpecieT(s)%FluxTubeT(f)%NqRTp(nn, Qind)* &
							(SpecieT(s)%FluxTubeT(f)%QCellT(Qind)% &
							d3xCT(1)/SpecieT(s)%FluxTubeT(f)%nsnormfacT(1))
					end if
