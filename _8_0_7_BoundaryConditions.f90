    ...
    ! ----------------------------------------------------
        ...
        ! ----------------------------------------------------
				...
				if (rank == 0) then
					...
					SpecieT(s)%FluxTubeT(f)%LBoutfluxIonRT(nn)= & ! LB ion escape flux [m^-2 s-1]
						...
						((SpecieT(s)%FluxTubeT(f)%d3xCGT(nn, SpecieT(s)%FluxTubeT(f)%NqLBT(1))/ &
						(SpecieT(s)%FluxTubeT(f)%hqCGT(nn, SpecieT(s)%FluxTubeT(f)%NqLBT(1))* &
						SpecieT(s)%FluxTubeT(f)%dqCGT(nn, SpecieT(s)%FluxTubeT(f)%NqLBT(1))))* &
						SpecieT(s)%FluxTubeT(f)%ndatfacGT(nn- 1)*SpecieT(s)%hT)
        ...
        ! ----------------------------------------------------
				...
				if (rank == 0) then
					...
					SpecieT(s)%FluxTubeT(f)%UBoutfluxIonRT(nn)= & ! UB ion escape flux [m^-2 s-1]
						SpecieT(s)%FluxTubeT(f)%NqUBoutfluxIonRT(nn)/ &
						((SpecieT(s)%FluxTubeT(f)%d3xCGT(nn, SpecieT(s)%FluxTubeT(f)%NqUBT(1))/ &
						(SpecieT(s)%FluxTubeT(f)%hqCGT(nn, SpecieT(s)%FluxTubeT(f)%NqUBT(1))* &
						SpecieT(s)%FluxTubeT(f)%dqCGT(nn, SpecieT(s)%FluxTubeT(f)%NqUBT(1))))* &
						SpecieT(s)%FluxTubeT(f)%ndatfacGT(nn- 1)*SpecieT(s)%hT)
        ...
        if (SpecieT(s)%FluxTubeT(f)%LBCONDITIONflagT(1) == 0) then
				...
				if (SpecieT(s)%FluxTubeT(f)%LBCONDITIONflagT(1) == 1) then
					...
					SpecieT(s)%FluxTubeT(f)%LBNetDensityT(nn)= &
						nint(SpecieT(s)%FluxTubeT(f)%nsnormCLBGT(nn)/ranksize(1))
          ...
          dNsTK2(1)= SpecieT(s)%FluxTubeT(f)%LBNetDensityT(nn)
					...
					if (SpecieT(s)%FluxTubeT(f)%CONVECTIONflagT(1) == 0) then
						if ((SpecieT(s)%FluxTubeT(f)%LBNetDensityT(nn) > &
        ...
        NsTK(1)= NsTK(1)+ dNsTK(1)
				...
				if (SpecieT(s)%FluxTubeT(f)%UBCONDITIONflagT(1) == 1) then
					...
					SpecieT(s)%FluxTubeT(f)%UBNetDensityT(nn)= &
						nint(SpecieT(s)%FluxTubeT(f)%nsnormCUBGT(nn)/ranksize(1))
					...
					if (SpecieT(s)%FluxTubeT(f)%CONVECTIONflagT(1) == 0) then
						if ((SpecieT(s)%FluxTubeT(f)%UBNetDensityT(nn) > &
